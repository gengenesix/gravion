...
const getScoreColor = (score: number) => {
  ...
  if (score >= 25)
    return 'text-yellow-400 bg-yellow-500/5 border-yellow-500/40 hover:bg-yellow-500/10 hover:border-yellow-500/60 shadow-[inset_0_0_15px_rgba(234,179,8,0.1)]';
  ...
  return (
    <div className="flex flex-col h-full space-y-4">
      <div className="flex items-center justify-between uppercase tracking-widest text-xs font-bold text-intel-text-light tech-panel-header pb-2">
        ...
        {isLoading && (
          <span className="text-intel-accent animate-pulse text-[10px]">SYNCING...</span>
        )}
      </div>
              ...
              <div className="flex justify-between items-end mb-2 relative z-10">
                ...
                <div className="flex flex-col items-end">
                  <div className="flex items-center gap-1">
                    ...
                    {country.trend.includes('UP') ? (
                      <TrendingUp size={16} />
                    ) : country.trend.includes('DOWN') ? (
