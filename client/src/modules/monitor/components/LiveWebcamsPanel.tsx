    ...
    <div className="flex flex-col h-full space-y-3">
      <div className="flex items-center justify-between uppercase tracking-widest text-xs font-bold text-intel-text-light tech-panel-header pb-2">
        ...
        <div className="flex items-center gap-2 text-xs shrink-0">
          <span className="text-intel-text truncate max-w-[120px] text-right">
          ...
          <button
            ...
            className={clsx(
              ...
              activeFeed.id === feed.id
                ? 'border-intel-accent drop-shadow-[0_0_5px_var(--color-intel-accent)]'
                : 'border-intel-accent/20 hover:border-intel-accent/50 filter grayscale hover:grayscale-0',
            )}
            style={{
          ...
          >
            <div
              className={clsx(
                ...
                activeFeed.id === feed.id
                  ? 'bg-gradient-to-t from-intel-accent/80 via-black/50 to-transparent mix-blend-multiply'
                  : 'bg-gradient-to-t from-black/90 via-black/50 to-black/20 group-hover:to-transparent',
              )}
            ></div>
